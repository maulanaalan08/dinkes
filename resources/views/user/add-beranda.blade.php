        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Tambah Beranda</h1>
                    <form method="post" action="{{ route('beranda.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="mb-3">
                            <label for="judul" class="form-label">Judul Beranda</label>
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Beranda">
                        </div>
                        <div class="mb-3">
                            <label for="detail" class="form-label">Detail Beranda</label>
                            <input type="text" class="form-control" id="detail" name="detail" placeholder="Masukkan Detail Beranda">
                        </div>
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Gambar Beranda</label>
                            <input type="file" class="form-control" id="formFile" name="gambar" placeholder="Masukkan Gambar Berita">
                        </div>
