                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="{{ route('layanan.create') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Layanan">
                        </div>
                        <div class="mb-3">
                            <label for="detail" class="form-label">Detail Layanan</label>
                            <input type="text" class="form-control" id="detail" name="detail" placeholder="Masukkan Detail Layanan">
                        </div>
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Gambar Layanan</label>
                            <input type="file" class="form-control" id="formFile" name="gambar" placeholder="Masukkan Gambar Layanan">
                        </div>
